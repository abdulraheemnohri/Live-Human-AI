...
@Singleton
class JalebiPermissionGate @Inject constructor(private val context: Context) {
    ...
    fun canPerceiveVision() = has(JalebiPermission.CAMERA)
    fun canPerceiveSpeech() = has(JalebiPermission.MICROPHONE)
}
