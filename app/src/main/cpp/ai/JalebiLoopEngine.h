...
public:
 ...
 bool startLoop(int loopId);bool pauseLoop(int loopId);bool resumeLoop(int loopId);bool replanLoop(int loopId,const std::string& reason,const std::string& nextAction="REPERCEIVE");bool cancelLoop(int loopId);bool completeLoop(int loopId);bool failLoop(int loopId,const std::string& reason);bool safetyBlockLoop(int loopId,const std::string& reason);
